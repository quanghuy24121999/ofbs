...
public class PromotionController {
	...
	public ResponseEntity<?> getPromotionsByRestaurantId(@PathVariable("restaurantId") long restaurantId) {
		List<IPromotionDTO> promotions = promotionService.getPromotionsByRestaurantId(restaurantId);
		return ResponseEntity.status(HttpStatus.OK).body(promotions);
	}
}
